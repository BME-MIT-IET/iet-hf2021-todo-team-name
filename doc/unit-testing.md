...
- Kesésbé átlátható, megérthetõ a kód.
...
Az egyszerûbb hibákat igyekeztünk kijavítani.
...
Még jól szervezett, átlátható kód esetén is elõfordulnak ezek a hibák,
rosszabb minõségû kódról nem is beszélve.
Az ilyen hibák kiszûrésére alkalmas egy jól átgondolt, lehetõleg minden eshetõségre gondoló teszthalmaz.
